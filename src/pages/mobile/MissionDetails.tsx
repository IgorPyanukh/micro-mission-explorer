...
const MissionDetails = () => {
        ...
        <CardContent className="p-4">
          ...
          {capturedImage ? (
            <div className="mb-4">
              ...
              {missionStatus !== "completed" && missionStatus !== "verified" && (
          ...
          ) : mission?.requiresImage && missionStatus !== "completed" && missionStatus !== "verified" ? (
            <div className="mb-4">
              <Button
                variant="outline"
  ...
  return (
    ...
    >
      ...
      {/* Submission Section - Show for available, in-progress, and completed missions */}
